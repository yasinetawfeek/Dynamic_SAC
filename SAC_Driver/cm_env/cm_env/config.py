...
MIN_SPAWN = 12                                  # Minimum distance along the track in which the vehicle can spawn
MAX_SPAWN = 150                               # Maximum distance along the track in which the vehicle can spawn
# MAX_SPAWN = 350                                 # Maximum distance along the track in which the vehicle can spawn
VEHICLE_START_POSITION_X = 12                   # Position at which the vehicle's first position will be (NOT THE SPAWN LOCATION)
# VEHICLE_START_POSITION_Y = 0                    # Position at which the vehicle's first position will be (NOT THE SPAWN LOCATION)
...
PROGRESS_FOR_COMPLETION = 0.9                   # Progress at which the goal is achieved
INITIAL_STEP_COUNTER = 5                        # Steps until initial reward is given

MAX_RPM = 400                                   # RPM limit for vehicle control
MAX_BRAKE_PERCENTAGE = 80                       # Brake percentage limit for vehicle control
MAX_STEERING_ANGLE = 15.0                       # Steering limit for vehicle control
...
SLEEP_AFTER_STOP = 4                            # Wait time after stopping episode
SLEEP_AFTER_START = 4                           # Wait time after starting episode
...
PATH_TO_TESTRUN_FILE = "/home/yasinetawfeek/Desktop/uwe-ipg-sim/Data/TestRun/oval_weave"
...
FUNCTION_FINAL_A3 = 40000                       # Reward for reaching end
